...
/**
 * Class that implements the Wall Follower using Proportional Control controller to avoid obstacles during navigation.
 * 
...
public class PController extends UltrasonicController {
  ...
  public static enum State {
    ...
    TURNING, // When robot is turning around a block
    FOLLOWING_WALL, // When robot has completed turning
    PASSED
  };

  // PController variables
...
System.out.println("asdf");
  ...
  /**
   * Compute difference between the orientation to the next waypoint and the current Odometer's orientation.
   * 
   * @return true if the absolute value of this difference is smaller than the stopping threshold and false otherwise
   */
