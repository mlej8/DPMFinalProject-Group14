...
public class LightCorrection {
	...
	/**
	 * Maximum ratio for last intensity compared to current intensity when there is
	 * no black line.
	 */
	...
	/**
	 * Perform an action based on the light data input. Method that corrects the
	 * robot's position during navigation. If the light sensors detect the black
	 * lines asynchronously, it will stop the motor that has detected the black line
	 * first until the second motor detects the black line.
	 * 
	 * @param leftCurIntensity:
	 *            Intensity measured by left light sensor
	 * @param rightCurIntensity:
	 *            Intensity measured by right light sensor
	 */
