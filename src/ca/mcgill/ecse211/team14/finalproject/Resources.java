...
/**
 * Class that stores all constants for the final project.
 * 
...
public class Resources {
	...
	/**
	 * Variable that keeps track of the distance between the light sensors and the
	 * motors.
	 */
	...
	/**
	 * d constant for ultrasonic localizer representing the threshold distance from
	 * the wall.
	 *
	 */
	...
	/**
	 * Degree at which to rotate right when executing ultrasonic sensor
	 * localization.
	 */
	...
	public static class Region {
		 ...
		 * 
		 * @param llX
		 *            the Wi-Fi parameter key representing the lower left corner of the
		 *            region x coordinate
		 * @param llY
		 *            the Wi-Fi parameter key representing the lower left corner of the
		 *            region y coordinate
		 * @param urX
		 *            the Wi-Fi parameter key representing the upper right corner of the
		 *            region x coordinate
		 * @param urY
		 *            the Wi-Fi parameter key representing the upper right corner of the
		 *            region y coordinate
