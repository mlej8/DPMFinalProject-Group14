...
public class findDestMethodTests {
  ...
  public void testDestination() {
    ...
    calculateIntersectionX(new Point(0,0), 6, 1, points);
    for(Point p: points) {
      p.x = keep3Digits(p.x);
      p.y = keep3Digits(p.y);
    }
  ...
  public void testDestination2() {
    ArrayList<Point> points = new ArrayList<Point>();
    calculateIntersectionX(new Point(0,0), 6, 2, points);
    for(Point p: points) {
      p.x = keep3Digits(p.x);
      p.y = keep3Digits(p.y);
    }
  ...
  public void testDestination3() {
    ArrayList<Point> points = new ArrayList<Point>();
    calculateIntersectionX(new Point(0,0), 6, 8, points);
    for(Point p: points) {
      p.x = keep3Digits(p.x);
      p.y = keep3Digits(p.y);
    }
  ...
  public void testDestination4() {
    ArrayList<Point> points = new ArrayList<Point>();
    calculateIntersectionY(new Point(0,0), 6, 4, points);
    for(Point p: points) {
      p.x = keep3Digits(p.x);
      p.y = keep3Digits(p.y);
    }
