 ...
 * point, tunnel exit point and launch point.
 * 
...
public class WIFI {
	...
	/**
	 * Calculate and set the launch angle based on the relative position of
	 * calculated launch point and bin point.
	 */
	...
	/**
	 * Calculate the intersection points of a circle's circumference with a vertical
	 * line.
	 * 
	 * @param center
	 *            A point indicating the center of a circle.
	 * @param radius
	 *            The radius of the circle.
	 * @param x
	 *            The given x value
	 * @param intersects
	 *            The modified list to store all intersections
	 */
	...
	/**
	 * Calculate the intersection points of a circle's circumference with a
	 * horizontal line.
	 * 
	 * @param center
	 *            A point indicating the center of a circle.
	 ...
	 * to travel to in order to enter the tunnel and exit the tunnel. In final
	 * competition, we might split it into getTunnelEntrance and getTunnelExit.
	 */
